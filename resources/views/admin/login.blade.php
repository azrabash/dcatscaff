...
{{--                     <center><img src="/vendor/dcat-admin/images/logo.png" width="100" height="100"></center>
                    <br> --}}
                    <h1 class="mt-0"><img src="/vendor/dcat-admin/images/logo.png" width="50" height="50"> <b>DCAT ADMIN</b></h1>
                    <h4 class="mt-0">Make backend development easier</h4>					
            ...
            <center><span class="text-primary">LARAVEL </span>v10.39.0 (PHP v8.1.10)</b></center>
            </div>
        </div>
...
<style>
    ...
    .login-page-right {
        ...
        background: rgba(0, 0, 0, 0.3) url('/vendor/dcat-admin/images/login.jpg') center;
